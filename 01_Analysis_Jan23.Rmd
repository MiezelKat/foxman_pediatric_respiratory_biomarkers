...
Mediation analysis were SARS-CoV-2 pathogen strength (i.e., SARS-CoV-2 Ct value) mediates the relationship of age on CXCL10 (log-transformed). It is on SARS-CoV-2 positive samples (no RSV) only ($n =$ `r nrow(data.mediation.covid)`). 
